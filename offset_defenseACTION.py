# -*- coding: utf-8 -*-
"""
Created on Wed May  9 12:15:18 2018
...
#ax.hlines([7],1,0, transform=ax.get_yaxis_transform(), colors='k')   
#ax.hlines([19],1,0, transform=ax.get_yaxis_transform(), colors='k')   
#ax.hlines([20],1,0, transform=ax.get_yaxis_transform(), colors='k')   
#ax.hlines([32],1,0, transform=ax.get_yaxis_transform(), colors='k')   
#ax.hlines([38],1,0, transform=ax.get_yaxis_transform(), colors='k')   
